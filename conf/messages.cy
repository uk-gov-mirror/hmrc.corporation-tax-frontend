...
subpage.sidebar.cert_of_residence = Cael tystysgrif preswylio
subpage.sidebar.help_and_contact = Cymorth a chysylltu
subpage.sidebar.more = Rhagor o fanylion Treth Gorfforaeth
subpage.sidebar.help_with_tax= Cynorthwyo
subpage.sidebar.navigation = Is-fordwyo Treth Gorfforaeth

subpage.more_options.dormant = Gwneud eich cwmni’n segur
subpage.more_options.close = Cau’ch cwmni
...
account.summary.file_a_return_prefix = Llenwch eich Ffurflen Dreth gan ddefnyddio
account.summary.file_a_return_link = meddalwedd fasnachol sy’n gweithio gyda Threth Gorfforaeth.
...
account.summary.worked_out = Sut y gwnaethom gyfrifo hyn
